...
contract FlightSuretyApp {
    ...
    */
                                 ...
                                 
    {
       ...
       // fData.registerAirline(0x8a6166aD3B40eC8787652c56De3c48605E7e56c5, msg.sender);
    ...
    */   
    ...
    function fundAirline (address air) external requireIsOperational returns(bool){
        bool result;
      // result = fData.fund(msg.value, air);
       result = fData.fund(10, air, msg.sender);
       return result;
    }

    
    function viewVariable(address air) requireIsOperational  returns(address){
        //address Var =registeredAirlines[0];
        address Var = fData.getregisteredAirline(air);
        return Var;
    }

        function getRegisteredAirline(address air)
        external view  requireIsOperational returns (address){
         address k  = fData.getregisteredAirline(air);
         return (k);
    }
    ...
    */  
    ...
    function buyInsurance(string flightNum) external requireIsOperational returns(bool){
        bool result;
         result = fData.buy(flightNum, msg.sender, 1);//have to change to double and less than 1 
         return true;
    }
